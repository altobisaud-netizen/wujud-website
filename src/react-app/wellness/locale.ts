...
export const copy = {
	en: {
		...
		heroEyebrow: "SARA is with you every day",
		...
		paymentPending: "Payment pending — access is granted only after payment confirmation.",
	...
	ar: {
		...
		waitlistCta: "أبلغني عند الإطلاق",
		saveJourneyCta: "احفظ رحلتك",
		paymentCta: "ابدأ رحلتي لمدة 8 أسابيع",
		paymentPending: "الدفع قيد الانتظار — يُمنح الوصول فقط بعد تأكيد الدفع.",
